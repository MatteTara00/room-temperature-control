function [K,rho,feas]=LMI_DT_DeDicont_perf_p(F,G,H,N,ContStruc,p)
...
% information structure specified by 'ContStruc'. It constrains the
% eigenvalues to stay in a circle of radius p (smaller than 1).
%
% Inputs:
% - F: system matrix.
...
% - p: radius of the inner constraining circle.
%
% Output:
...
LMIconstr=[[(p^2)*P-F*P*F'-F*L'*Gtot'-Gtot*L*F' Gtot*L;
